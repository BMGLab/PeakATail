...
\textbf{Use rank-stratified proportions instead}: rank 1 is the proximal-most
site, higher ranks progressively distal, and read share moving from high to low
ranks across stages is what shortening looks like in this metric. Unlike the mean,
it is free to vary.
\end{quote}
