...
| 19 | Switch strategy real-data comparison | `switch_strategy_real_data.png` | **DATA — withdrawn** |
| 20 | Length strategy real-data comparison | `length_strategy_real_data.png` | **DATA — withdrawn** |
| 21 | Gene walk: DPYD | `gene_walk_ENSG00000188641.png` | **DATA — withdrawn** |
| 22 | Gene walk: PHACTR1 | `gene_walk_ENSG00000112137.png` | **DATA — withdrawn** |
